(function() {
    ...
    var networks = [
        ...
        },
        {
            name: "MarteXcoin",
            onSelect: function() {
                network = bitcoin.networks.martexcoin;
                DOM.bip44coin.val(180);
            },
        },
        {
            name: "Myriadcoin",
        ...
        },
        {
            name: "Goacoin",
            onSelect: function() {
                network = bitcoin.networks.goacoin;
                DOM.bip44coin.val(176);
            },
        },
        {
            name: "Rapture",
            onSelect: function() {
                network = bitcoin.networks.rapture;
                DOM.bip44coin.val(321);
            },
        },
        {
            name: "Innova",
            onSelect: function() {
                network = bitcoin.networks.innovacoin;
                DOM.bip44coin.val(5);
            },
        },
        {
            name: "Crowd",
            onSelect: function() {
                network = bitcoin.networks.crowdcoin;
                DOM.bip44coin.val(5);
            },
        },
        {
            name: "EmergencyCoin",
            onSelect: function() {
                network = bitcoin.networks.emergencycoin;
                DOM.bip44coin.val(6);
            },
        },
        {
            name: "GunCoin",
            onSelect: function() {
                network = bitcoin.networks.guncoin;
                DOM.bip44coin.val(0);
            },
        },
        {
            name: "Unitus",
            onSelect: function() {
                network = bitcoin.networks.unitus;
                DOM.bip44coin.val(2);
            },
        },
        {
            name: "Sobercoin",
            onSelect: function() {
                network = bitcoin.networks.sobercoin;
                DOM.bip44coin.val(2);
            },
        },
        {
            name: "Bitblocks",
            onSelect: function() {
                network = bitcoin.networks.bitblocks;
                DOM.bip44coin.val(119);
            },
        },
        {
        ...
        },
        {
            name: "Freecoin",
            onSelect: function() {
                network = bitcoin.networks.freecoin;
                DOM.bip44coin.val(252);
            },
        },
        {
            name: "Trezarcoin",
            onSelect: function() {
                network = bitcoin.networks.trezarcoin;
                DOM.bip44coin.val(17);
            },
        },
    ]
